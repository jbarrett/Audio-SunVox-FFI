...
BEGIN {
    ...
    $binds = {
        ...
        sv_get_time_map                 => [ [qw/ int int opaque int /]                     => 'int',    \&_get_time_map ],
        ...
        sv_get_module_scope2            => [ [qw/ int int int opaque uint32 /]              => 'uint32', \&_get_module_scope ],
        sv_module_curve                 => [ [qw/ int int int opaque int int/]              => 'int',    \&_module_curve ],
