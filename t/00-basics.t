...
my $generator = call_ok sv_new_module( $slot, "Generator", "foo" ),
    "Created generator";
ok $generator == sv_find_module( $slot, "foo" ), "Can find generator";
...
call_ok sv_set_module_ctl_value( $slot, $generator, 0, 0x8000, 0 ),
    "Can set module value";
usleep(100_000); # IPC, audio system latency.
